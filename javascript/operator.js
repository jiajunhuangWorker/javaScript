...
/*ascll码比较*/
console.info('10>8:','10'>'8',' //两个字符串比较先查找到1然后1和8进行比较');
console.info('Infinity == Infinity:',Infinity == Infinity);
...
&&
*/
console.info('1 && 3+2:',(1 && 3+2));
console.info('0 && 3+2:',(0 && 3+2));
console.info('1 && undefined:',(1 && undefined));
console.info('0 && console.info("a"):',0 && console.info("a"));
console.info('console.info("a") && 0:',console.info("a") && 0);
/*
||
兼容的时候使用
 var e=e||window.event
*/
console.info('0||false||1:',0||false||1);
/*
！
*/
...
if(score!=0){
	...
	console.info('2的'+score+'次幂是:',num);
}else{
	console.info('2的0次幂是:1');
}
...
console.info(''+score4+'反转之后:'+result);
/*
5.a,b,c三个数字比较
*/
...
console.info(''+score6+'的质数有:'+str+'7-5-3-2');
